                                                        ...
                                                        <>
                                                            <div className="flex flex-col gap-2 mb-4">
                                                                ...
                                                                <div className="flex items-center justify-center md:justify-start gap-1.5 text-xs font-medium text-gray-400">
                                                                    ...
                                                                    {foundMovie?.genres && (Array.isArray(foundMovie.genres) ? foundMovie.genres.length > 0 : String(foundMovie.genres).trim().length > 0)
                                                                        ? (Array.isArray(foundMovie.genres) ? foundMovie.genres.join(', ') : String(foundMovie.genres))
                            ...
                            <div className="bg-[#08090e] border border-white/10 rounded-2xl p-6 relative">
                                ...
                                <div className="flex justify-center">
                                    <button
                                        ...
                                        className={`w-full max-w-sm px-10 py-3.5 rounded-xl font-bold text-sm flex items-center justify-center gap-2 transition-all shadow-lg ${loading || (availabilityStatus === 'available' && !requestType.includes('tv_channel'))
                                    ...
                                    <ul className="space-y-6 text-sm text-gray-400">
                                        <li className="flex items-start gap-4">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <p className="text-xs">Un film uniquement.</p>
                                            </div>
                                        </li>
                                        <li className="flex items-start gap-4">

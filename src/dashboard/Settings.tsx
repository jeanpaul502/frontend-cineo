...
export default function Settings() {
    ...
    const tabs = [
        { id: 'account', label: 'Compte', icon: 'solar:user-circle-linear' },
        { id: 'profile', label: 'Profil', icon: 'solar:user-id-linear' },
        { id: 'notifications', label: 'Notifications', icon: 'solar:bell-bing-linear' },
        { id: 'security', label: 'Sécurité', icon: 'solar:shield-keyhole-linear' },
        { id: 'sessions', label: 'Sessions', icon: 'solar:devices-linear' },
    ];
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <div className="relative">
                                                    ...
                                                    <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-1.5 px-2 py-1 bg-green-500/10 rounded-md border border-green-500/20">
                                                        <Icon icon="solar:verified-check-linear" className="text-green-500" width={14} />
                    ...
                    <Modal isOpen={showDeleteModal} onClose={() => setShowDeleteModal(false)}>
                        <div className="p-8 text-center">
                            <div className="w-20 h-20 bg-red-500/10 rounded-full flex items-center justify-center mx-auto mb-6 text-red-500 shadow-[0_0_30px_rgba(239,68,68,0.2)]">
                                <Icon icon="solar:danger-triangle-linear" width={40} />
                            </div>
                    ...
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
                        ...
                        >
                            ...
                            <div className="flex items-center justify-between mb-8">
                                ...
                                >
                                    <Icon icon="solar:close-circle-linear" width={24} className="text-gray-500" />
                                </button>
                            </div>
                                        ...
                                        >
                                            <div className="flex items-center justify-between mb-4">
                                                <div className={`p-2 rounded-lg ${
                                                    ...
                                                    <Icon icon={plan.type === 'vip' ? 'solar:crown-star-linear' : 'solar:cup-first-linear'} width={20} />
                                                </div>
                                                {profile.subscriptionType === plan.type && (

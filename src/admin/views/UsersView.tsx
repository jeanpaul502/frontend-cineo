...
const UsersView: React.FC = () => {
        ...
        try {
            ...
            const mappedUsers: User[] = data.map(u => {
                ...
                if (u.lastDevice) {
                    ...
                    deviceObj = { type, os: u.lastDevice, name: u.lastDevice };
                }
                ...
                return {
                    ...
                    isEmailVerified: u.isVerified ?? false, // ✅ real isVerified from backend
                    device: deviceObj
                };
            });
    ...
    const getDeviceIcon = (type: string, os: string) => {
        ...
        if (osLower.includes('android') || osLower.includes('ios')) return 'solar:smartphone-linear';
                            ...
                            {(() => {
                                ...
                                return (
                                    <>
                                        ...
                                        >
                                            <div className="w-8 h-8 rounded-lg bg-teal-500/10 flex items-center justify-center text-teal-400 group-hover:bg-teal-500 group-hover:text-white transition-colors">
                        ...
                        {modalType === 'edit' && (
                            <>
                                <div className="h-20 w-full bg-teal-500/10 flex items-center justify-center relative overflow-hidden">
                                    ...
                                    <Icon icon="solar:pen-new-square-bold-duotone" width="30" className="text-teal-400 drop-shadow-lg" />
                                </div>
                                <div className="p-6 space-y-4">
                                    ...
                                    <div className={`flex items-center justify-between p-3 rounded-xl border transition-all cursor-pointer ${
                                        ...
                                        <div className="flex items-center gap-3">
                                            <Icon
                                                icon={editForm.isVerified ? 'solar:verified-check-bold' : 'solar:danger-circle-bold'}
                                                width="20"
                                            ...
                                            {modalType === 'subscription' && (
                                                <div className="space-y-4">
                                                    ...
                                                    <div className="grid grid-cols-3 gap-2">
                                                        {([
                                                            { id: 'free', label: 'Gratuit', icon: 'solar:crown-bold', color: 'text-yellow-400', activeBg: 'bg-yellow-500/10 border-yellow-500/50', activeText: 'text-yellow-400' },
                                                            { id: 'premium', label: 'Premium', icon: 'solar:cup-first-bold', color: 'text-blue-400', activeBg: 'bg-blue-500/10 border-blue-500/50', activeText: 'text-blue-400' },
                                                            { id: 'vip', label: 'VIP', icon: 'solar:crown-star-bold', color: 'text-purple-400', activeBg: 'bg-purple-500/10 border-purple-500/50', activeText: 'text-purple-400' },
                                                        ] as const).map((plan) => (
                                                            <button
                                                                key={plan.id}

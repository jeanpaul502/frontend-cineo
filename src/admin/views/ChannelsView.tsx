        ...
        try {
            if (modalMode === 'create_playlist') {
                if (selectedPlaylist) {
                    ...
                    setPlaylists(playlists.map(p => p.id === updatedPlaylist.id ? { ...updatedPlaylist, channels: updatedPlaylist.channels || [] } : p));
                    ...
                    setPlaylists([...playlists, { ...newPlaylist, channels: newPlaylist.channels || [] }]);

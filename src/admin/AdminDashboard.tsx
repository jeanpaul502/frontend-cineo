    ...
    useEffect(() => {
        const fetchUser = async () => {
            try {
                ...
                try {
                    const [users, movies, channels] = await Promise.all([
    ...
    if (isLoading) {
        return (
            <div className="min-h-screen bg-black flex flex-col items-center justify-center gap-4">
                ...
                <p className="text-gray-400 text-sm font-medium animate-pulse">Chargement du panneau d'administration...</p>
            </div>
        );
    }
                    ...
                    {activeTab === 'overview' && (
                        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6 mb-8 ani-slide-in">
                            ...
                            <div className="bg-white/5 border border-white/10 p-6 rounded-2xl backdrop-blur-sm hover:bg-white/10 transition-colors">
                                ...
                                <h3 className="text-3xl font-bold text-white">{totalMovies.toLocaleString()}</h3>
                            </div>
                            ...
                            <div className="bg-white/5 border border-white/10 p-6 rounded-2xl backdrop-blur-sm hover:bg-white/10 transition-colors">
                                ...
                                <h3 className="text-3xl font-bold text-white">{totalChannels.toLocaleString()}</h3>
                            </div>
